...
pub fn download_from_link(link: String) -> Result<String, Box<dyn std::error::Error + Send + Sync>> {
...
pub fn move_and_tag_file(filename: String, metadata: TrackMetadata) -> Result<(), Box<dyn std::error::Error + Send + Sync>> {
